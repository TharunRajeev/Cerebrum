...
function App() {
  ...
  const temp = `
<h2>Introducing Cerebrum</h2>
Cerebrum is a half-baked, Notion style WYSIWYG editor that is built on top of TipTap(Another way of saying "I just copy-pasted the code from TipTap examples"). 
<br />
<h3>Features</h3>
<ul>
  ...
  return (
    <>
      <header>
        <h1>Cerebrum</h1>
        <a
          href="https://github.com/TharunRajeev"
          target="_blank"
          rel="noopener noreferrer"
        >
          {Icons.github} TharunRajeev/Cerebrum
        </a>
      </header>
